...
def _filter_params(params: T_PARAM_LIST, ignore_xargs: Any=..., ignore_xkwargs: Any=..., **kwargs: Any) -> Dict[str, T_PARAM]: ...
...
class LayeredContext:
    ...
    def _enter(self, context: Optional[Union[K, Any]]) -> Any: ...
    def _exit(self, result: Any): ...
    def _virt_enter(self) -> None: ...
    def _virt_exit(self): ...
...
def auto_list(obj: V, conv: Union[Type[T], Callable[[V], T]]=..., force_wrap: Any=..., force_iter: Any=..., **kw: Any) -> T: ...
